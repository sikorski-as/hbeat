...
# production environment should provide proper secret key as environment variable, otherwise it's a security issue
...
try:
    # get database information from the system variable
